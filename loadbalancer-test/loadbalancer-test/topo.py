...
if __name__ == "__main__":
    ...
    #h2.intf('s2-eth2').setIP('192.168.3.105/24')

    #s1.intf('s3-eth5').setIP('10.221.0.1/24')
    ...
    if len(sys.argv) == 2:
        ...
        h2.cmd('taskset --cpu-list 0 python -m http.server 80 &')
        h3.cmd('taskset --cpu-list 1 python -m http.server 80 &')
        h4.cmd('taskset --cpu-list 2 python -m http.server 80 &')
        h5.cmd('taskset --cpu-list 3 python -m http.server 80 &')
        h2.cmd('taskset --cpu-list 0 python server.py 0 &')
        h3.cmd('taskset --cpu-list 1 python server.py 1 &')
        h4.cmd('taskset --cpu-list 2 python server.py 2 &')
        h5.cmd('taskset --cpu-list 3 python server.py 3 &')
        #h4.cmd('taskset --cpu-list 2 python test.py &')
        #h5.cmd('taskset --cpu-list 3 python test.py &')
    CLI(net)
